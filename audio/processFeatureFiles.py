...
def processFeatureFiles(category = "trn"):
    filename = "../config/lrw1000/audio/" + category + "_1000.txt"
    ...
    while True:
        try:
            ...
            if filename in fnToWord.keys():
                ...
                try:
                    foldername =  '../feature/audio/' + word + '/' + category
                ...
                for idx in range(999):   
                    featfilename = '../feature/audio/' + word + '/' + category + '/' + filename + "_" + str(idx + 1) +'.pkl'
