...
def get_LRW1000_splits():
    parser = argparse.ArgumentParser(description='Script for creating main splits of LRW_1000.')
    ...
    parser.add_argument('--CMUdict_path', default='../data/vocab/dict.json')
